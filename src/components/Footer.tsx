...
function Footer() {
  return (
    <footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4 !mt-32">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          >
            <div className="self-center m-auto w-[50%] h-[50%] font-bold whitespace-nowrap text-[#ce9251] dark:text-white dark:hover:text-[#ce9251]">
              <Image className="" src="/logo.png" width={500} height={500} alt="logo" />
            </div>
          </Link>
        ...
        <span className="block justify-center text-sm text-gray-500 text-center dark:text-gray-400">
          ...
          <Link
            href="/"
            className="hover:underline hover:text-[#ce9251]"
          >
            DevTechsposure™
          </Link>
          . All Rights Reserved.
